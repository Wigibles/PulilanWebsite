/**
 * Pulilan: Kasaysayan at Pamana — Museum Cultural Archive
 * Exact historical records and content as curated for Pulilan, Bulacan.
 */
...
const PULILAN_DATA = {
  meta: {
    ...
    gateway: "NLEX Pulilan Exit (Km 45)"
  },

  places: [
    {
      id: "san-isidro-church",
      name: "Diocesan Shrine and Parish of San Isidro Labrador",
      shortName: "Church",
      location: "Poblacion, Pulilan, Bulacan",
      coverImage: "assets/San Isidro Church.jpg",
      gallery: [
        "assets/San Isidro Church.jpg",
        "assets/Kneeling Carabao Festival.jpg",
        "assets/Spanish Colonial Era Cemetery.jpg"
      ],
    ...
    {
      id: "pulong-kabyawan",
      name: "Pulong Kabyawan",
      shortName: "Pulong Kabyawan",
      location: "Barangay Inaon, Pulilan, Bulacan, Philippines",
      coverImage: "assets/PulongKabyawan.jpg",
      gallery: [
        "assets/PulongKabyawan.jpg",
        "assets/PulongKabyawanCoffeeShop.jpg",
        "assets/PulongKabyawanHouse.jpg",
        "assets/PulongKabyawanKubo.jpg",
        "assets/PulongKabyawanOtherPhotos.jpeg"
      ],
      ...
      history: "Pulong Kabyawan was developed as a community effort to preserve the agricultural land and heritage of Barangay Inaon in Pulilan. According to Cartellino, residents led by Andrew Alto de Guzman worked to protect the area as industrialization began to expand around it. The project eventually became an example of community-based tourism, where local farmers and cultural workers work together to preserve the land while allowing visitors to experience farm life.\n\nThe name “Pulong Kabyawan” is associated with the agricultural character of the area and is translated in the Cartellino article as “Island of Carabao Mills.” The place continues to function as a farm, while also welcoming visitors who want to experience its cultural and natural environment.",
      culturalSignificance: "Pulong Kabyawan is significant because it helps preserve the agricultural heritage of Pulilan while connecting it with art and culture. Visitors can see the relationship between farming, traditional ways of life, and local artistic expression.\n\nOne of its important features is Museo Pulong Kabyawan, which showcases artworks by artists from Bulacan and Pampanga and presents the history of the farm and the lives of people connected to it. The site also has traditional farm structures and spaces that reflect provincial life.",
      references: [
        { label: "Cartellino Feature: How farmers and cultural workers teamed up to preserve heritage", url: "https://cartellino.com/features/2023/01/24/How-farmers-and-cultural-workers-teamed-up-to-preserve-Bulacans-agricultural-built-and-artistic-heritage" },
        { label: "NinjaMoves: Pulong Kabyawan Bulacan Travel Guide", url: "https://ninjammoves.com/travel/philippines/pulong-kabyawan-bulacan/" }
      ]
    },

    {
      id: "campo-santo-cemetery",
      name: "Spanish Colonial Era Cemetery (Campo Santo)",
      shortName: "Campo Santo",
      location: "Beside the San Isidro Labrador Church, Poblacion, Pulilan, Bulacan",
      coverImage: "assets/Spanish Colonial Era Cemetery.jpg",
      gallery: [
        "assets/Spanish Colonial Era Cemetery.jpg",
        "assets/Spanish Colonial Era Cemetery Other.jpg",
        "assets/Spanish Colonial Era Cemetery Other 1.jpg"
      ],
      ...
      history: "The cemetery dates back to the late 18th century, during the Spanish colonial period in the Philippines. It was established beside the church, following the traditional arrangement of having burial grounds within or near a church compound.\n\nThe cemetery is surrounded by adobe walls, while its entrance is a three-level stone-and-brick structure with an arched pediment. These structures show the architectural style and construction materials associated with older Spanish-era religious sites.\n\nThe cemetery has remained an important historical feature of Pulilan and continues to stand beside the San Isidro Labrador Church, connecting the present community with the town's colonial-era past.",
      culturalSignificance: "The cemetery provides a physical connection to Pulilan's history during the Spanish colonial period. Its location beside the church reflects how religious life and burial traditions were closely connected in earlier communities.\n\nFrom an Art Appreciation perspective, the cemetery is also valuable because of its architecture and visual details. The old adobe walls, stone-and-brick entrance, arched design, and historic graves demonstrate how structures can become part of a community's cultural heritage.",
      references: [
        { label: "Official Pulilan Tourism Registry: Pulilan Cemetery", url: "https://celebrate.pulilan.gov.ph/tourism/Pulilan-Cemetery/40" }
      ]
    },

    {
      id: "north-polo-club",
      name: "The North Polo Club (NPC)",
      shortName: "North Polo Club",
      location: "Big Ben Farm, Pulilan, Bulacan",
      coverImage: "assets/North Polo Club.jpg",
      gallery: [
        "assets/North Polo Club.jpg",
        "assets/North Polo Club Other Photo.jpg",
        "assets/North Polo Club Other Photo 1.jpg"
      ],
      shortDescription: "A luxury 26-hectare private equestrian club, known for its magnificent polo fields and green landscapes. It features open grounds for training, practice chukkers, tournaments, and private equestrian events, and offers riding and polo lessons for beginners.",
      history: "The North Polo Club (NPC) was established in 2014 by businessman, art collector, and polo player, Bigboy Eduardo. It was established to promote polo sport in the Philippines. Eduardo developed the agricultural lands in Pulilan, into an outstanding sports destination including specialized polo fields, riding arenas, and stables that are able to accommodate dozens of thoroughbred horses.",
      culturalSignificance: "NPC placed Pulilan town into international equestrian map, changing its agricultural reputation into that of sports tourism destination. It changed the image from being a farming community into a center for sports tourism and high society. This place, which used to be farming land before it became a modernized place, has been given an enhancement through the inclusion of international standard polo fields and horse breeding as a result of the rich history of horses in the area.\n\nThe place hosts national and international polo tournaments, encouraging interest of locals into equestrian discipline, breeding and field sports.",
      references: [
        { label: "North Polo Club Official Facebook Page", url: "https://www.facebook.com/northpoloclub/" },
        { label: "Celebrate Pulilan Tourism: North Polo Club", url: "https://celebrate.pulilan.gov.ph/tourism/North-Polo-Club/35" }
      ]
    },

    {
      id: "casa-san-francisco",
      name: "Casa San Francisco (Laxamana House)",
      shortName: "Casa San Francisco",
      location: "Poblacion, Pulilan, Bulacan",
      coverImage: "assets/Casa San Francisco.jpg",
      gallery: [
        "assets/Casa San Francisco.jpg",
        "assets/Casa San Francisco Interior 1.jpg",
        "assets/Casa San Francisco Interior 2.jpg"
      ],
  ...
  foods: [
...

    {
      ...
      howServed: "First, the duck is boiled in strongly spiced broth in order to tenderize its meat and to remove the gamey taste. After draining and drying, it is fried in the cooking oil and made extremely crispy. It is served hot and chopped into pieces at local carinderias and specialty restaurants and is usually eaten with warm rice or drinks.",
      connectionToPulilan: "Pulilan's proximity to the Angat River and irrigated rice fields created ideal conditions for duck farming (pag-iitik). The ducks were used for balut and salted eggs and old ducks were reused by Pulilan residents for this dish. Roadside cooks transformed the agricultural byproduct into a special local treat.",
      culturalSignificance: "The Fried Itik is a testament to the ingenuity of Bulakenyo cooking which turned farm-raised domesticated poultry into a much loved local delicacy. Through many years of roadside vendors selling itik stalls and impromptu dining places along the national roads, Pulilan became a stop-over for travelers in search of local cuisine, cementing its status as an important part of Bulakan's culinary culture and popular pulutan (beer companion). It is the perfect example of resourcefulness of Bulakenyo cuisine. Nowadays, Fried Itik became the signature savory dish of Pulilan, drawing many tourists.",
      interestingFacts: "The trick to the game-free taste of Fried Itik is a laborious procedure whereby the duck is first boiled in a combination of vinegar, garlic, bay leaves, peppercorn, and spices to soften the connective tissues and eliminate any smell, after which it is fried till crispy on the outside. It is usually accompanied by the signature local sauce – either a hot and sour vinegar and garlic dip or a liver-based sauce.",
      references: [
        { label: "Dentong's Fried Itik — Official Facebook Page", url: "https://www.facebook.com/p/Dentongs-Fried-Itik-100064170966596/" },
        { label: "Magtalas Itikan Farm Duck Recipe", url: "https://magtalasitikanfarm.wordpress.com/2018/07/31/fried-itik-duck-recipe/?hl=hi-IN" },
        { label: "Philippine Daily Inquirer: Exotic Fried Itik Food Guide to Bulacan", url: "https://lifestyle.inquirer.net/225847/lethal-chicharon-exotic-fried-itik-your-food-guide-to-bulacan/?utm_source=gemini&hl=hi-IN" }
      ]
    }
  ],

  emergencyContacts: [
    { agency: "Pulilan MDRRMO (Disaster & Medical Rescue)", phone: "(044) 815-2882 / 0922-832-1550" },
    { agency: "Pulilan Municipal Police Station", phone: "(044) 665-1222 / 0998-598-5374" },
    { agency: "Pulilan Fire Station (BFP)", phone: "(044) 815-1111" },
    { agency: "Pulilan Rural Health Unit (RHU)", phone: "(044) 815-2015" }
  ]
};

if (typeof window !== 'undefined') {
  window.PULILAN_DATA = PULILAN_DATA;
}
